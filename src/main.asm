...
X5d4f:
                ...
                ld bc, 0x805 ; box 5x8
                call Draw_intro_box
                call Print_iy ; clears screen with spaces
; 5d64

                db 0xcd, 0xde, 0x5d, 0xcd,   0xde, 0x5d, 0x3e, 0x42, 0x32, 0x9c, 0x5a, 0xcd
...
X5dd8:          call Print_iy
                ...
                db 0xcd, 0xe6
                db 0x5d, 0x26, 0x01, 0xc3, 0x21, 0x83
...
Box_sides:
                ...
                org 0x5f06
                db 0x98, 0x34,   0xcf, 0xd0, 0xd1, 0xff, 0xdf, 0xe0, 0xe1, 0x00
...
3               ld bc, (Print.String_alt.next_line_coord)
                ...
                org 0x6a13
                db 0xfa, 0xfd, 0xf0, 0x02, 0x1c,   0xf8, 0xa2, 0x15, 0x7f, 0xea, 0x40, 0x05, 0x2a
